...
public interface TablistContentProvider {
    ...
    /**
     * This method is called when the tablist is updated. <p>
     * The order of the returned groups is the order in which they are displayed. Players not included in any group are displayed last. <p>
